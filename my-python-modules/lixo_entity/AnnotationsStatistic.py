...
class AnnotationsStatistic:
    ...
    def process_ssd_pascal_voc_model(self,
        annotation_format, input_image_size, classes, 
        image_dataset_folder_train, 
        image_dataset_folder_valid, 
        image_dataset_folder_test
    ...
    # def process_image_annotations(self, model_name, step_name, annotations_list, annotation_statistics):
    def process_image_annotations(self,
        annotation_format, 
        input_image_size, 
        input_dataset_type,
        classes,
